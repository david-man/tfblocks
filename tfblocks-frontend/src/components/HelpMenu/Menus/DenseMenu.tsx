    ...
    return <div className = 'w-full h-95/100 flex flex-col items-center overflow-y-auto rounded-3xl'>
        ...
        <p className = 'text-2xl text-center p-1 pt-3'>Guide</p>
         <ul className = 'list-disc list-inside pl-2 pb-3 pr-3'>
            ...
            <li>At their core, their job is to turn an input vector with 'F' features into an output vector with 'U' units. They do this by computing a weighted sum of all input features for every unit based on how important they think each feature is.</li>
