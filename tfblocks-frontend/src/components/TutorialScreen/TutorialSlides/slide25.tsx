    ...
    return (
        <>
            <div className = 'absolute z-5 h-full w-full flex flex-col justify-center items-center'>
                ...
                <p className = 'text-[25px] text-white text-center p-[20px]'>
                    To 'go along an axis', then, refers to looking at each item along that axis. For example, if your input is of shape [10,4,9], going along the 1st axis would mean considering 4 matrices of size [10, 1, 9].
                </p>
                <p className = 'text-[25px] text-white text-center p-[20px]'>
                    These matrices are called 'features'.
                </p>
                <p className = 'text-[25px] text-white text-center p-[20px]'>You can find more information about shapes and axes through the individual layer help menus!</p>
            </div>
        </>
    )
}
