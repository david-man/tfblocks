    ...
    return (
        <div className = 'absolute z-5 h-full w-full flex flex-col justify-center items-center'>
            ...
            <div className = 'absolute z-10 top-0 left-0 h-6/10 w-full flex flex-col justify-center items-center'>
                <p className = 'text-white text-[25px]'>Handles that look like this are called output handles</p>
                <p className = 'text-white text-[25px]'>These handles tell tfBlocks where the output(s) of a layer should go</p>
                <br />
                <p className = 'text-white text-[25px]'>They're a lot more flexible; they can connect to one, multiple, or no input handles!</p>
            </div>
            {exampleNode}
        </div>
    )
